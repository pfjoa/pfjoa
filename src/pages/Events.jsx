    ...
    <div className='container mx-auto w-10/12 mt-10'>
      <div className='flex flex-col items-center space-y-10 justify-between xl:flex-row'>
        <div className='flex flex-col gap-[2vh] justify-evenly'>
          <h1 className='text-[#040650] font-bold text-4xl lg:w-[450px] text-center xl:text-start'>Events</h1>
          <p className='text-[#717171] max-w-[450px] min-w-[250px] text-base text-center xl:text-justify'>
